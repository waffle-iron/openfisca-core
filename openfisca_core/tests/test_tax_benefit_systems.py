...
def test_get_legislation_with_path():
    taux = tax_benefit_system.get_legislation(path='csg.activite.deductible.taux')
...
def test_get_legislation_with_instant():
    legislation_json = tax_benefit_system.get_legislation(instant='2010-01-01')
...
def test_get_legislation_with_path_and_instant():
    abattement = tax_benefit_system.get_legislation(path='csg.activite.deductible.abattement', instant='2010-01-01')
